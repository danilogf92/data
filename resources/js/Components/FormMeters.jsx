...
export default function FormMeters() {
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg p-4 bg-gray-100/50">
            <form>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        id="difference"
                                        readOnly
                                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 disabled:bg-gray-100 sm:text-sm sm:leading-6"
                                    />
                                </div>
                            </div>
